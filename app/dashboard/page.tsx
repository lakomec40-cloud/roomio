    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          ...
          <a href="/spravy" className="p-6 bg-white border border-gray-100 rounded-2xl hover:border-indigo-200 transition-colors">
            <div className="text-2xl mb-2">💬</div>
            <h2 className="font-semibold text-gray-900">Správy</h2>
            <p className="text-sm text-gray-500 mt-1">Konverzácie s ostatnými používateľmi</p>
          </a>
        </div>
